...
public static class RenderFactory
{
    ...
    public static IRendererOld Create(string id) => _instance = id switch
    {
    ...
    private static IRendererOld CreateOpenGLRenderer()
    {
        return new Renderer.OpenGL();
    }

    private static IRendererOld CreateMetalRenderer()
    {
        return new Renderer.MetalOld();
    }
}